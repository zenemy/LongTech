    ...
    void uploadData() throws SQLiteException {
        ...
        try {
            ...
            if (cursorTransaction2.moveToFirst()) {
                do {
                    String nodoc = cursorTransaction2.getString(0);
                    String datatype = cursorTransaction2.getString(1);
                    String subdatatype = cursorTransaction2.getString(2);
                    String itemdata = cursorTransaction2.getString(3);
                    String subitemdata = cursorTransaction2.getString(4);
                    String compid = cursorTransaction2.getString(5);
                    String siteid = cursorTransaction2.getString(6);
                    String date1 = cursorTransaction2.getString(7);
                    String date2 = cursorTransaction2.getString(8);
                    String date3 = cursorTransaction2.getString(9);
                    String date4 = cursorTransaction2.getString(10);
                    String date5 = cursorTransaction2.getString(11);
                    String text1 = cursorTransaction2.getString(12);
                    String text2 = cursorTransaction2.getString(13);
                    String text3 = cursorTransaction2.getString(14);
                    String text4 = cursorTransaction2.getString(15);
                    String text5 = cursorTransaction2.getString(16);
                    String text6 = cursorTransaction2.getString(17);
                    String text7 = cursorTransaction2.getString(18);
                    String text8 = cursorTransaction2.getString(19);
                    String text9 = cursorTransaction2.getString(20);
                    String text10 = cursorTransaction2.getString(21);
                    String text11 = cursorTransaction2.getString(22);
                    String text12 = cursorTransaction2.getString(23);
                    String text13 = cursorTransaction2.getString(24);
                    String text14 = cursorTransaction2.getString(25);
                    String text15 = cursorTransaction2.getString(26);
                    String text16 = cursorTransaction2.getString(27);
                    String text17 = cursorTransaction2.getString(28);
                    String text18 = cursorTransaction2.getString(29);
                    String text19 = cursorTransaction2.getString(30);
                    String text20 = cursorTransaction2.getString(31);
                    String text21 = cursorTransaction2.getString(32);
                    String text22 = cursorTransaction2.getString(33);
                    String text23 = cursorTransaction2.getString(34);
                    String text24 = cursorTransaction2.getString(35);
                    String text25 = cursorTransaction2.getString(36);
                    String text26 = cursorTransaction2.getString(37);
                    String text27 = cursorTransaction2.getString(38);
                    String text28 = cursorTransaction2.getString(39);
                    String text29 = cursorTransaction2.getString(40);
                    String text30 = cursorTransaction2.getString(41);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, server_url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if (jsonPostTR02.getString("UPLOAD").equals("SUCCESS")) {
                                    dbHelper.change_statusuploadtr02(nodoc);
                                    isUploadDone = true;
                                    afterEventUpload();
                                }
                            } catch (JSONException e) {
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            paramstr02.put("nodoctr2", nodoc);
                            paramstr02.put("datatypetr2", datatype);
                            paramstr02.put("subdatatypetr2", subdatatype);
                            paramstr02.put("itemdatatr2", itemdata);
                            paramstr02.put("subitemdatatr2", subitemdata);
                            paramstr02.put("compidtr2", compid);
                            paramstr02.put("siteidtr2", siteid);
                            paramstr02.put("date1tr2", date1);
                            paramstr02.put("date2tr2", date2);
                            paramstr02.put("date3tr2", date3);
                            paramstr02.put("date4tr2", date4);
                            paramstr02.put("date5tr2", date5);
                            paramstr02.put("text1tr2", text1);
                            paramstr02.put("text2tr2", text2);
                            paramstr02.put("text3tr2", text3);
                            paramstr02.put("text4tr2", text4);
                            paramstr02.put("text5tr2", text5);
                            paramstr02.put("text6tr2", text6);
                            paramstr02.put("text7tr2", text7);
                            paramstr02.put("text8tr2", text8);
                            paramstr02.put("text9tr2", text9);
                            paramstr02.put("text10tr2", text10);
                            paramstr02.put("text11tr2", text11);
                            paramstr02.put("text12tr2", text12);
                            paramstr02.put("text13tr2", text13);
                            paramstr02.put("text14tr2", text14);
                            paramstr02.put("text15tr2", text15);
                            paramstr02.put("text16tr2", text16);
                            paramstr02.put("text17tr2", text17);
                            paramstr02.put("text18tr2", text18);
                            paramstr02.put("text19tr2", text19);
                            paramstr02.put("text20tr2", text20);
                            paramstr02.put("text21tr2", text21);
                            paramstr02.put("text22tr2", text22);
                            paramstr02.put("text23tr2", text23);
                            paramstr02.put("text24tr2", text24);
                            paramstr02.put("text25tr2", text25);
                            paramstr02.put("text26tr2", text26);
                            paramstr02.put("text27tr2", text27);
                            paramstr02.put("text28tr2", text28);
                            paramstr02.put("text29tr2", text29);
                            paramstr02.put("text30tr2", text30);
